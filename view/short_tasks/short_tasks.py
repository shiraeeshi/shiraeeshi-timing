...
from logic.short_tasks_ops import extract_short_tasks_from_processes_tree

def show_short_tasks():
    window = gtk.Window()
    window.set_title("Short Tasks")
    ...
    app_functions_file = os.path.join(ROOT_DIR, "frontend", "short_tasks.functions.js")
    ...
    app_styles_file = os.path.join(ROOT_DIR, "frontend", "short_tasks.styles.css")
    ...
    with open(config_file) as f:
        ...
        shorttasks = extract_short_tasks_from_processes_tree(processes_info)
        composed_info = {
    ...
    app_html_file = os.path.join(ROOT_DIR, "frontend", "short_tasks.html")
