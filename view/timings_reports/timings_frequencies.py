...
def show_timings_frequencies():
    ...
    app_my_file = os.path.join(ROOT_DIR, "frontend", "timings_reports", "timings_frequencies.my.js")
    ...
    app_functions_file = os.path.join(ROOT_DIR, "frontend", "timings_reports", "timings_frequencies.functions.js")
    ...
    app_styles_file = os.path.join(ROOT_DIR, "frontend", "timings_reports", "timings_frequencies.styles.css")
