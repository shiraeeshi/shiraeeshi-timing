...
function handleServerMessage(msg) {
  try {
    let shorttasks_object = msg.shorttasks;
    showShorttasks(shorttasks_object);
  } catch (err) {
    window.webkit.messageHandlers.shrttsks.postMessage("js handleServerMessage error msg: " + err.message);
  }
}
...
function showShorttasks(processes_object) {
  let processesWrapper = document.getElementById("short-tasks-content-wrapper");
